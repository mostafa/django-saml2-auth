...
> [!IMPORTANT]
> This project is a fork of [grafana/django-saml2-auth](https://github.com/grafana/django-saml2-auth), which was a fork of [fangli/django-saml2-auth](https://github.com/fangli/django-saml2-auth). The [maintainer no longer works at Grafana](https://github.com/grafana/django-saml2-auth/issues/396#issuecomment-4204617928) and is not added as an external contributor on the Grafana repository, so ongoing maintenance happens in this fork ([mostafa/django-saml2-auth](https://github.com/mostafa/django-saml2-auth)). The PyPI package name is unchanged: [`grafana-django-saml2-auth`](https://pypi.org/project/grafana-django-saml2-auth/).
...
- For contribution, read [contributing guide](CONTRIBUTING.md). To report security issues privately, see [SECURITY.md](SECURITY.md).
